...
import es.udc.asi.postexamplerest.model.service.dto.BarberProfileDTO;
...
public class BarberProfileResource {
    ...
    @GetMapping("/{login}")
    public ResponseEntity<BarberProfileDTO> getBarberProfile(@PathVariable String login) {
        ...
        BarberProfileDTO barberProfileDTO = new BarberProfileDTO(
                ...
                barbero.getProfileImageUrl(),
                horarios
        );

        return ResponseEntity.ok(barberProfileDTO);
    }
}
