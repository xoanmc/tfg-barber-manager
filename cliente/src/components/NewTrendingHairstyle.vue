      ...
      <div class="card-body p-4">
        ...
        <form @submit.prevent="guardarPeinado">
          ...
          <div class="mb-3">
            ...
            <textarea id="descripcion" class="form-control" v-model="nuevoPeinado.descripcionTendencias" rows="3"
              required></textarea>
          </div>
          ...
          <div class="mb-3">
            ...
            <div class="form-check" v-for="estructura in estructurasFaciales" :key="estructura">
              <input class="form-check-input" type="checkbox" :id="estructura" :value="estructura"
...
import { estructuraFacialMap, getBackendKey } from "@/estructuraFacialMap";
...
export default {
  data() {
    return {
      ...
      estructurasFaciales: Object.values(estructuraFacialMap),
      error: ""
    };
  },
  methods: {
    ...
    async guardarPeinado() {
      try {
        // convertir nombres del frontend al formato del backend antes de enviar
        const estructurasBackend = this.nuevoPeinado.estructurasFaciales.map(getBackendKey);
        ...
        formData.append("estructurasFaciales", estructurasBackend.join(","));
